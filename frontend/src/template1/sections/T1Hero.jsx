...
const T1Hero = () => {
  ...
  return (
    <section className="relative min-h-screen w-full overflow-hidden flex flex-col justify-between">
      ...
      <div
        className="absolute inset-0 bg-[linear-gradient(rgba(18,16,16,0)_50%,rgba(0,0,0,0.15)_50%),linear-gradient(90deg,rgba(255,0,0,0.02),rgba(255,0,0,0.01),rgba(255,0,0,0.02))] bg-[length:100%_3px,3px_100%]"
      />
      ...
      <div className="relative z-10 flex-1 flex flex-col items-center justify-center text-center px-4 sm:px-6 lg:px-8 py-20 sm:py-24 w-full">
        ...
        >
          <h1 className="font-heading font-bold text-[clamp(1.6rem,3.2vw,3.8rem)] tracking-tight text-foreground mb-6 drop-shadow-[0_4px_24px_rgba(0,0,0,0.9)] text-center leading-[1.05] w-full mx-auto whitespace-nowrap">
        ...
        <motion.p
          ...
          className="font-heading text-xl sm:text-2xl md:text-3xl lg:text-4xl font-bold tracking-[0.18em] uppercase text-foreground mb-10 drop-shadow-[0_4px_24px_rgba(0,0,0,0.9)] text-center"
        >
      ...
      {/* Stats Strip */}
      <div className="relative z-10 pb-8 pt-4 bg-black/50 backdrop-blur-md border-t border-border/20">
